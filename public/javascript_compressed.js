...
(function (root, factory) {
  ...
  var module$contents$Blockly$JavaScript_JavaScript =
    new $.module$exports$Blockly$Generator.Generator('JavaScript');
  module$contents$Blockly$JavaScript_JavaScript.addReservedWords(
    'break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,in,instanceof,new,return,super,switch,this,throw,try,typeof,var,void,while,with,yield,enum,implements,interface,let,package,private,protected,public,static,await,null,true,false,arguments,' +
      Object.getOwnPropertyNames($.module$exports$Blockly$utils$global.globalThis).join(',')
  );
  ...
  module$contents$Blockly$JavaScript_JavaScript.ORDER_OVERRIDES = [
    ...
    [
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_NOT,
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_NOT,
    ],
    [
      module$contents$Blockly$JavaScript_JavaScript.ORDER_MULTIPLICATION,
      module$contents$Blockly$JavaScript_JavaScript.ORDER_MULTIPLICATION,
    ],
    [
      module$contents$Blockly$JavaScript_JavaScript.ORDER_ADDITION,
      module$contents$Blockly$JavaScript_JavaScript.ORDER_ADDITION,
    ],
    [
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_AND,
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_AND,
    ],
    [
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_OR,
      module$contents$Blockly$JavaScript_JavaScript.ORDER_LOGICAL_OR,
    ],
  ];
  ...
  module$contents$Blockly$JavaScript_JavaScript.init = function (a) {
    ...
    this.nameDB_
      ? this.nameDB_.reset()
      : (this.nameDB_ = new $.module$exports$Blockly$Names.Names(this.RESERVED_WORDS_));
    this.nameDB_.setVariableMap(a.getVariableMap());
    this.nameDB_.populateVariables(a);
    this.nameDB_.populateProcedures(a);
    for (
      var b = [], c = (0, $.module$exports$Blockly$Variables.allDeveloperVariables)(a), d = 0;
      d < c.length;
      d++
    )
      b.push(
        this.nameDB_.getName(c[d], $.module$exports$Blockly$Names.NameType.DEVELOPER_VARIABLE)
      );
    a = (0, $.module$exports$Blockly$Variables.allUsedVarModels)(a);
    for (c = 0; c < a.length; c++)
      b.push(this.nameDB_.getName(a[c].getId(), $.module$exports$Blockly$Names.NameType.VARIABLE));
  ...
  module$contents$Blockly$JavaScript_JavaScript.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = (0, $.module$exports$Blockly$utils$string.wrap)(e, this.COMMENT_WRAP - 3)),
        (d += this.prefixLines(e + '\n', '// ')));
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type === $.module$exports$Blockly$inputTypes.inputTypes.VALUE &&
  ...
  $.Blockly.JavaScript.variables_set = function (a) {
    var b =
      $.Blockly.JavaScript.valueToCode(a, 'VALUE', $.Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
    return (
      $.Blockly.JavaScript.nameDB_.getName(
        a.getFieldValue('VAR'),
        $.module$exports$Blockly$Names.NameType.VARIABLE
  ...
  var module$exports$Blockly$JavaScript$texts = {},
    ...
    module$contents$Blockly$JavaScript$texts_forceString = function (a) {
      return module$contents$Blockly$JavaScript$texts_strRegExp.test(a)
  ...
  $.Blockly.JavaScript.text_join = function (a) {
    switch (a.itemCount_) {
      ...
      case 1:
        return (
          (a =
            $.Blockly.JavaScript.valueToCode(a, 'ADD0', $.Blockly.JavaScript.ORDER_NONE) || "''"),
          module$contents$Blockly$JavaScript$texts_forceString(a)
        );
      case 2:
        var b =
          $.Blockly.JavaScript.valueToCode(a, 'ADD0', $.Blockly.JavaScript.ORDER_NONE) || "''";
        ...
        return [
          module$contents$Blockly$JavaScript$texts_forceString(b)[0] +
            ' + ' +
            module$contents$Blockly$JavaScript$texts_forceString(a)[0],
          $.Blockly.JavaScript.ORDER_ADDITION,
        ];
      default:
        ...
        for (var c = 0; c < a.itemCount_; c++)
          b[c] =
            $.Blockly.JavaScript.valueToCode(a, 'ADD' + c, $.Blockly.JavaScript.ORDER_NONE) || "''";
  ...
  $.Blockly.JavaScript.text_length = function (a) {
    return [
      ($.Blockly.JavaScript.valueToCode(a, 'VALUE', $.Blockly.JavaScript.ORDER_MEMBER) || "''") +
        '.length',
    ...
    var b = a.getFieldValue('WHERE') || 'FROM_START',
      c =
        $.Blockly.JavaScript.valueToCode(
          a,
          'VALUE',
          'RANDOM' === b ? $.Blockly.JavaScript.ORDER_NONE : $.Blockly.JavaScript.ORDER_MEMBER
        ) || "''";
    switch (b) {
      case 'FIRST':
    ...
    if (e.match(/^'?\w+'?$/) || d) {
      switch (b) {
        case 'FROM_START':
          ...
          break;
        case 'FROM_END':
          b = $.Blockly.JavaScript.getAdjusted(
            a,
            'AT1',
            1,
            !1,
      ...
      switch (c) {
        case 'FROM_START':
          ...
          break;
        case 'FROM_END':
          c = $.Blockly.JavaScript.getAdjusted(
            a,
            'AT2',
            0,
            !1,
      ...
      e =
        $.Blockly.JavaScript.provideFunction_(
          ...
          '\nfunction ' +
            ...
            ') {\n  var start = ' +
            module$contents$Blockly$JavaScript$texts_getSubstringIndex('sequence', b, 'at1') +
            ';\n  var end = ' +
            module$contents$Blockly$JavaScript$texts_getSubstringIndex('sequence', c, 'at2') +
  ...
  $.Blockly.JavaScript.text_changeCase = function (a) {
    var b = { UPPERCASE: '.toUpperCase()', LOWERCASE: '.toLowerCase()', TITLECASE: null }[
  ...
  $.Blockly.JavaScript.text_trim = function (a) {
    ...
    return [
      ($.Blockly.JavaScript.valueToCode(a, 'TEXT', $.Blockly.JavaScript.ORDER_MEMBER) || "''") + b,
      $.Blockly.JavaScript.ORDER_FUNCTION_CALL,
    ];
  };
  ...
  $.Blockly.JavaScript.text_reverse = function (a) {
    return [
      ($.Blockly.JavaScript.valueToCode(a, 'TEXT', $.Blockly.JavaScript.ORDER_MEMBER) || "''") +
        ".split('').reverse().join('')",
      $.Blockly.JavaScript.ORDER_FUNCTION_CALL,
    ];
  };
  ...
  $.Blockly.JavaScript.procedures_defreturn = function (a) {
    ...
    for (var h = [], k = a.getVars(), l = 0; l < k.length; l++)
      h[l] = $.Blockly.JavaScript.nameDB_.getName(
        k[l],
        $.module$exports$Blockly$Names.NameType.VARIABLE
      );
    c = 'function ' + b + '(' + h.join(', ') + ') {\n' + c + d + e + g + f + '}';
  ...
  $.Blockly.JavaScript.procedures_callreturn = function (a) {
    for (
      ...
      c[e] =
        $.Blockly.JavaScript.valueToCode(a, 'ARG' + e, $.Blockly.JavaScript.ORDER_NONE) || 'null';
  ...
  $.Blockly.JavaScript.procedures_ifreturn = function (a) {
    var b =
      'if (' +
      ($.Blockly.JavaScript.valueToCode(a, 'CONDITION', $.Blockly.JavaScript.ORDER_NONE) ||
        'false') +
      ') {\n';
    $.Blockly.JavaScript.STATEMENT_SUFFIX &&
    ...
    a.hasReturnValue_
      ? ((a =
          $.Blockly.JavaScript.valueToCode(a, 'VALUE', $.Blockly.JavaScript.ORDER_NONE) || 'null'),
  ...
  $.Blockly.JavaScript.math_number = function (a) {
    ...
    return [
      a,
      0 <= a ? $.Blockly.JavaScript.ORDER_ATOMIC : $.Blockly.JavaScript.ORDER_UNARY_NEGATION,
    ];
  };
  $.Blockly.JavaScript.math_arithmetic = function (a) {
    ...
    return c
      ? [d + c + a, b]
      : ['Math.pow(' + d + ', ' + a + ')', $.Blockly.JavaScript.ORDER_FUNCTION_CALL];
  };
  $.Blockly.JavaScript.math_single = function (a) {
    ...
    if ('NEG' === b)
      return (
        (a =
          $.Blockly.JavaScript.valueToCode(a, 'NUM', $.Blockly.JavaScript.ORDER_UNARY_NEGATION) ||
          '0'),
        '-' === a[0] && (a = ' ' + a),
  ...
  $.Blockly.JavaScript.math_number_property = function (a) {
    var b = {
        ...
        PRIME: [null, $.Blockly.JavaScript.ORDER_NONE, $.Blockly.JavaScript.ORDER_FUNCTION_CALL],
      },
    ...
    var d = b.next().value,
      e = b.next().value;
    b = b.next().value;
    e = $.Blockly.JavaScript.valueToCode(a, 'NUMBER_TO_CHECK', e) || '0';
    'PRIME' === c
      ? (a =
          $.Blockly.JavaScript.provideFunction_(
            'mathIsPrime',
      ...
      : 'DIVISIBLE_BY' === c
        ? ((a =
            $.Blockly.JavaScript.valueToCode(a, 'DIVISOR', $.Blockly.JavaScript.ORDER_MODULUS) ||
            '0'),
          (a = e + ' % ' + a + ' === 0'))
        : (a = e + d);
    return [a, b];
  ...
  $.Blockly.JavaScript.math_change = function (a) {
    var b =
      $.Blockly.JavaScript.valueToCode(a, 'DELTA', $.Blockly.JavaScript.ORDER_ADDITION) || '0';
  ...
  $.Blockly.JavaScript.math_on_list = function (a) {
    ...
    switch (b) {
      ...
      case 'MAX':
        ...
        break;
      case 'AVERAGE':
        b = $.Blockly.JavaScript.provideFunction_(
          'mathMean',
          '\nfunction ' +
            $.Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  $.Blockly.JavaScript.math_modulo = function (a) {
    var b =
      $.Blockly.JavaScript.valueToCode(a, 'DIVIDEND', $.Blockly.JavaScript.ORDER_MODULUS) || '0';
  ...
  $.Blockly.JavaScript.math_atan2 = function (a) {
    ...
    return [
      'Math.atan2(' +
        ($.Blockly.JavaScript.valueToCode(a, 'Y', $.Blockly.JavaScript.ORDER_NONE) || '0') +
        ', ' +
        b +
        ') / Math.PI * 180',
  ...
  $.Blockly.JavaScript.controls_repeat_ext = function (a) {
    ...
    var d = $.Blockly.JavaScript.nameDB_.getDistinctName(
      ...
      e = b;
    b.match(/^\w+$/) ||
      (0, $.module$exports$Blockly$utils$string.isNumber)(b) ||
  ...
  $.Blockly.JavaScript.controls_for = function (a) {
    ...
    if (
      ...
      (a = ''),
        ...
        (a += 'var ' + d + ' = '),
        (a = (0, $.module$exports$Blockly$utils$string.isNumber)(e)
          ? a + (Math.abs(e) + ';\n')
          : a + ('Math.abs(' + e + ');\n')),
        (a =
          a +
  ...
  $.Blockly.JavaScript.controls_forEach = function (a) {
    var b = $.Blockly.JavaScript.nameDB_.getName(
      ...
      c =
        $.Blockly.JavaScript.valueToCode(a, 'LIST', $.Blockly.JavaScript.ORDER_ASSIGNMENT) || '[]',
      d = $.Blockly.JavaScript.statementToCode(a, 'DO');
    d = $.Blockly.JavaScript.addLoopTrap(d, a);
    a = '';
    var e = c;
  ...
  $.Blockly.JavaScript.controls_flow_statements = function (a) {
    ...
    if ($.Blockly.JavaScript.STATEMENT_PREFIX) {
      ...
      c &&
        ...
        (b += $.Blockly.JavaScript.injectId($.Blockly.JavaScript.STATEMENT_PREFIX, c));
    }
  ...
  $.Blockly.JavaScript.controls_if = function (a) {
    ...
    do {
      var d =
          $.Blockly.JavaScript.valueToCode(a, 'IF' + b, $.Blockly.JavaScript.ORDER_NONE) || 'false',
    ...
    if (a.getInput('ELSE') || $.Blockly.JavaScript.STATEMENT_SUFFIX)
      (b = $.Blockly.JavaScript.statementToCode(a, 'ELSE')),
        $.Blockly.JavaScript.STATEMENT_SUFFIX &&
          (b =
            $.Blockly.JavaScript.prefixLines(
              $.Blockly.JavaScript.injectId($.Blockly.JavaScript.STATEMENT_SUFFIX, a),
  ...
  $.Blockly.JavaScript.logic_operation = function (a) {
    var b = 'AND' === a.getFieldValue('OP') ? '&&' : '||',
      c =
        '&&' === b ? $.Blockly.JavaScript.ORDER_LOGICAL_AND : $.Blockly.JavaScript.ORDER_LOGICAL_OR,
  ...
  $.Blockly.JavaScript.logic_ternary = function (a) {
    var b =
        $.Blockly.JavaScript.valueToCode(a, 'IF', $.Blockly.JavaScript.ORDER_CONDITIONAL) ||
        'false',
      c =
        $.Blockly.JavaScript.valueToCode(a, 'THEN', $.Blockly.JavaScript.ORDER_CONDITIONAL) ||
        'null';
    a =
      $.Blockly.JavaScript.valueToCode(a, 'ELSE', $.Blockly.JavaScript.ORDER_CONDITIONAL) || 'null';
  ...
  $.Blockly.JavaScript.lists_create_with = function (a) {
    for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++)
      b[c] =
        $.Blockly.JavaScript.valueToCode(a, 'ADD' + c, $.Blockly.JavaScript.ORDER_NONE) || 'null';
    return ['[' + b.join(', ') + ']', $.Blockly.JavaScript.ORDER_ATOMIC];
  };
  $.Blockly.JavaScript.lists_repeat = function (a) {
    var b = $.Blockly.JavaScript.provideFunction_(
        'listsRepeat',
        '\nfunction ' +
          $.Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(value, n) {\n  var array = [];\n  for (var i = 0; i < n; i++) {\n    array[i] = value;\n  }\n  return array;\n}\n'
    ...
    var b = a.getFieldValue('MODE') || 'GET',
      ...
      d =
        $.Blockly.JavaScript.valueToCode(
          a,
          'VALUE',
          'RANDOM' === c ? $.Blockly.JavaScript.ORDER_NONE : $.Blockly.JavaScript.ORDER_MEMBER
        ) || '[]';
    switch (c) {
      case 'FIRST':
  ...
  $.Blockly.JavaScript.lists_setIndex = function (a) {
    ...
    var c = $.Blockly.JavaScript.valueToCode(a, 'LIST', $.Blockly.JavaScript.ORDER_MEMBER) || '[]',
      ...
      f =
        $.Blockly.JavaScript.valueToCode(a, 'TO', $.Blockly.JavaScript.ORDER_ASSIGNMENT) || 'null';
    switch (e) {
      case 'FIRST':
      ...
      b =
        $.Blockly.JavaScript.provideFunction_(
          ...
          '\nfunction ' +
            ...
            ') {\n  var start = ' +
            module$contents$Blockly$JavaScript$lists_getSubstringIndex('sequence', c, 'at1') +
            ';\n  var end = ' +
            module$contents$Blockly$JavaScript$lists_getSubstringIndex('sequence', d, 'at2') +
            ' + 1;\n  return sequence.slice(start, end);\n}\n'
        ) +
        '(' +
        b +
  ...
  $.Blockly.JavaScript.lists_sort = function (a) {
    var b =
        $.Blockly.JavaScript.valueToCode(a, 'LIST', $.Blockly.JavaScript.ORDER_FUNCTION_CALL) ||
        '[]',
      c = '1' === a.getFieldValue('DIRECTION') ? 1 : -1;
    a = a.getFieldValue('TYPE');
    var d = $.Blockly.JavaScript.provideFunction_(
      'listsGetSortCompare',
      '\nfunction ' +
        $.Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  $.Blockly.JavaScript.colour_blend = function (a) {
    var b =
        $.Blockly.JavaScript.valueToCode(a, 'COLOUR1', $.Blockly.JavaScript.ORDER_NONE) ||
        "'#000000'",
      c =
        $.Blockly.JavaScript.valueToCode(a, 'COLOUR2', $.Blockly.JavaScript.ORDER_NONE) ||
        "'#000000'";
