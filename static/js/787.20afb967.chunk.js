'use strict';
(self.webpackChunkr_blocks = self.webpackChunkr_blocks || []).push([
  [787],
  {
    787: function (e, n, t) {
      t.r(n),
      ...
      var i,
        ...
        w = new Date(),
        L = function (e, n) {
          i || ((i = n), (r = e), (a = new Date()), k(removeEventListener), S());
        },
        S = function () {
          if (r >= 0 && r < a - w) {
            var e = {
        ...
        P = function (e, n) {
          ...
          if (o) {
            t = m(e, r, n);
            var v = function () {
              C[r.id] || (o.takeRecords().map(a), o.disconnect(), (C[r.id] = !0), t(!0));
            };
            ['keydown', 'click'].forEach(function (e) {
              ...
              s(function (i) {
                (r = u('LCP')),
                  ...
                  requestAnimationFrame(function () {
                    requestAnimationFrame(function () {
                      (r.value = performance.now() - i.timeStamp), (C[r.id] = !0), t(!0);
                    });
                  });
              });
          }
...
//# sourceMappingURL=787.20afb967.chunk.js.map
